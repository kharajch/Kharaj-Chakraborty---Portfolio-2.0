export const projectsData = [
  {
    ...
    lang: ["Stitch", "NextJS", "CSS", "JavaScript", "Framer Motion", "GSAP", "Three.js", "Opus 4.6", "Gemini 3 Pro Preview"],
    repo: "https://github.com/kharajch/kharajch---WebXResearch",
    img: "/images/projects/WebXResearch.png",
    details:
      "Kharaj Chakraborty---WebXResearch turns information overload into instant clarity. Drop in a link to any article, blog, documentation, or paper — and the app fetches the content, processes it through Google Gemini, and returns a beautifully structured summary complete with key takeaways and topic tags. Need to go deeper? The built-in AI Chat lets you ask follow-up questions directly against the webpage's context, just like talking to a research assistant who already read the whole page for you.",
  },
  {
